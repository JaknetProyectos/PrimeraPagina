      ...
      <div class="container">
        ...
        <div class="content">
          ...
          <p style="text-align: center; font-size: 12px; color: #999; margin-top: 30px;">
            Si necesitas ayuda con tu pedido contesta este correo o escribe a <strong>contacto@vivamytrip.com</strong>
          </p>
        </div>

        <div class="footer">
          © ${new Date().getFullYear()} Viva My Trip México | vivamytrip.com
        </div>
      </div>
    </body>
    </html>
